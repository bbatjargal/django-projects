...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Getting Started &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="prev" title="pgAdmin 4" href="index.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="index.html" title="pgAdmin 4"
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>Getting Started<a class="headerlink" href="#getting-started" title="Permalink to this headline">¶</a></h1>
...
whenever possible.</p>
<p>In a Server Deployment, the pgAdmin application is deployed behind a webserver
...
administrative role can use the pgAdmin <em>User Management</em> dialog to create
...
associated with that login role.</p>
<p>Contents:</p>
...
<li class="toctree-l2"><a class="reference internal" href="server_deployment.html#configuration">Configuration</a><ul>
<li class="toctree-l3"><a class="reference internal" href="server_deployment.html#python">Python</a></li>
<li class="toctree-l3"><a class="reference internal" href="server_deployment.html#apache-httpd-configuration-windows">Apache HTTPD Configuration (Windows)</a></li>
<li class="toctree-l3"><a class="reference internal" href="server_deployment.html#apache-httpd-configuration-linux-unix">Apache HTTPD Configuration (Linux/Unix)</a></li>
</ul>
</li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="pgadmin_login.html">pgAdmin Login Dialog</a></li>
<li class="toctree-l1"><a class="reference internal" href="pgadmin_user.html">User Management Dialog</a></li>
<li class="toctree-l1"><a class="reference internal" href="change_user_password.html">Change User Password Dialog</a></li>
</ul>
</div>
<p>In a Desktop Deployment, the pgAdmin application is configured to use the
...
<p class="last">Pre-compiled and configured installation packages are available for
...
<p>The pgAdmin 4 client features a highly-customizable display that features
drag-and-drop panels that you can arrange to make the best use of your desktop
environment.</p>
<p>The tree control provides an elegant overview of the managed servers, and the
...
for the selected object.</p>
<p>The tabbed browser provide quick access to statistical information about each
...
and re-arrange feature tabs as needed.</p>
<p>Use the <em>Preferences</em> dialog to customize the content and colors of the pgAdmin
display.  To open the <em>Preferences</em> dialog, select <em>Preferences</em> from the <em>File</em> menu.</p>
<p><em>Help</em> buttons in the lower-left corner of each dialog will open the online help
for the dialog.  You can access additional Postgres help by navigating through
the <em>Help</em> menu, and selecting the name of the resource that you wish to open.</p>
<p>Contents:</p>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="browser.html">The pgAdmin 4 Client</a></li>
<li class="toctree-l1"><a class="reference internal" href="pgadmin_menu_bar.html">pgAdmin Menu Bar</a></li>
<li class="toctree-l1"><a class="reference internal" href="pgadmin_tabbed_browser.html">pgAdmin Tabbed Browser</a></li>
<li class="toctree-l1"><a class="reference internal" href="pgadmin_tree_control.html">pgAdmin Tree Control</a></li>
<li class="toctree-l1"><a class="reference internal" href="preferences.html">Preferences Dialog</a></li>
<li class="toctree-l1"><a class="reference internal" href="keyboard_shortcuts.html">Keyboard Shortcuts</a></li>
</ul>
</div>
<p>Before using pgAdmin to manage objects that reside on a server, you must define a
connection to the server; for more information please see <em>Connecting to a Server</em>:</p>
<p>Contents:</p>
<div class="toctree-wrapper compound">
<ul>
