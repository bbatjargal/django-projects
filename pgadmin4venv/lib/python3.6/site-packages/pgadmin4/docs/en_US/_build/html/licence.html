...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Licence &#8212; pgAdmin 4 3.1 documentation</title>
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>Licence<a class="headerlink" href="#licence" title="Permalink to this headline">¶</a></h1>
<p>pgAdmin is released under the  <a class="reference external" href="http://www.postgresql.org/about/licence">PostgreSQL Licence</a>, which is a  liberal Open Source licence similar to BSD or MIT, and approved by the Open  Source Initiative. The copyright for the project source code, website and documentation is attributed to the <a class="reference external" href="https://www.pgadmin.org/development/team.php">pgAdmin Development Team</a>.</p>
</div>
