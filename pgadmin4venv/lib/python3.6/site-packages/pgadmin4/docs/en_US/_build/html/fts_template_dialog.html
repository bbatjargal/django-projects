...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>FTS Template Dialog &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="Function Dialog" href="function_dialog.html" />
    <link rel="prev" title="FTS Parser Dialog" href="fts_parser_dialog.html" /> 
  </head><body>
  ...
  <div class="section" id="fts-template-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>FTS Template Dialog<a class="headerlink" href="#fts-template-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>FTS Template</em> dialog to create a new text search template. A text search template defines the functions that implement text search dictionaries.</p>
<p>The <em>FTS Template</em> dialog organizes the development of a text search Template through the following dialog tabs: <em>General</em>, and <em>Definition</em>. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="FTS template dialog general tab" src="_images/fts_template_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a template:</p>
<ul class="simple">
<li>Use the <em>Name</em> field to add a descriptive name for the template. The name will be displayed in the <em>pgAdmin</em> tree control.</li>
<li>Select the name of the schema in which the template will reside from the drop-down listbox in the <em>Schema</em> field.</li>
<li>Store notes about the template in the <em>Comment</em> field.</li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="FTS template dialog definition tab" src="_images/fts_template_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define function parameters:</p>
<ul class="simple">
<li>Use the drop-down listbox next to <em>Init function</em> to select the name of the init function for the template. The init function is optional.</li>
<li>Use the drop-down listbox next to <em>Lexize function</em> to select the name of the lexize function for the template. The lexize function is required.</li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>FTS Template</em> dialog generate a SQL command (see an example below). Use the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL command.</p>
<p><strong>Example</strong></p>
<p>The following is an example of the sql command generated by user selections in the <em>FTS Template</em> dialog:</p>
<img alt="FTS template dialog sql tab" src="_images/fts_template_sql.png" />
<p>The example shown demonstrates creating a fts template named <em>ru_template</em> that uses the ispell dictionary.</p>
<ul class="simple">
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">FTS Template Dialog</a></li>
