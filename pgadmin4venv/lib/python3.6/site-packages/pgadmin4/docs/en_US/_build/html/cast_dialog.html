...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Cast Dialog &#8212; pgAdmin 4 3.1 documentation</title>
  ...
  <div class="section" id="cast-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Cast Dialog<a class="headerlink" href="#cast-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Cast</em> dialog to define a cast. A cast specifies how to convert a value from one data type to another.</p>
<p>The <em>Cast</em> dialog organizes the development of a cast through the following dialog tabs: <em>General</em> and <em>Definition</em>. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="Cast dialog general tab" src="_images/cast_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the cast:</p>
<ul class="simple">
<li>The <em>Name</em> field is disabled. The name that will be displayed in the <em>pgAdmin</em> tree control is the <em>Source</em> type concatenated with the <em>Target</em> type, and is generated automatically when you make selections on the <em>Cast</em> dialog <em>Definition</em> tab.</li>
<li>Store notes about the cast in the <em>Comment</em> field.</li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Cast dialog definition tab" src="_images/cast_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define parameters:</p>
<ul class="simple">
<li>Use the drop-down listbox next to <em>Source type</em> to select the name of the source data type of the cast.</li>
<li>Use the drop-down listbox next to <em>Target type</em> to select the name of the target data type of the cast.</li>
<li>Use the drop-down listbox next to <em>Function</em> to select the function used to perform the cast. The function’s result data type must match the target type of the cast.</li>
<li>Move the <em>Context</em> switch to the <em>Implicit</em> position if the cast is implicit. By default, a cast can be invoked only by an explicit cast request. If the cast is marked <em>Implicit</em> then it can be invoked implicitly in any context, whether by assignment or internally in an expression.</li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>Cast</em> dialog generate a SQL command (see an example below). Use the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL command.</p>
<p><strong>Example</strong></p>
<p>The following is an example of the sql command generated by user selections in the <em>Cast</em> dialog:</p>
<img alt="Cast dialog sql tab" src="_images/cast_sql.png" />
<p>The cast uses a function named <em>int4(bigint)</em> to convert a biginteger data type to an integer.</p>
<ul class="simple">
