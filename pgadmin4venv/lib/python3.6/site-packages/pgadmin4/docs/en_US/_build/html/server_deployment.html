...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Server Deployment &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="pgAdmin Login Dialog" href="pgadmin_login.html" />
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>Server Deployment<a class="headerlink" href="#server-deployment" title="Permalink to this headline">¶</a></h1>
...
application under <code class="docutils literal notranslate"><span class="pre">Apache</span> <span class="pre">HTTP</span></code>, using <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code>.</p>
...
<h3>Apache HTTPD Configuration (Windows)<a class="headerlink" href="#apache-httpd-configuration-windows" title="Permalink to this headline">¶</a></h3>
...
<h3>Apache HTTPD Configuration (Linux/Unix)<a class="headerlink" href="#apache-httpd-configuration-linux-unix" title="Permalink to this headline">¶</a></h3>
<p>Once Apache HTTP has been configured to support <code class="docutils literal notranslate"><span class="pre">mod_wsgi</span></code>, the pgAdmin
application may be configured similarly to the example below:</p>
<div class="highlight-apache notranslate"><div class="highlight"><pre><span></span><span class="nt">&lt;VirtualHost</span> <span class="s">*</span><span class="nt">&gt;</span>
    <span class="nb">ServerName</span> pgadmin.example.com
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Server Deployment</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#requirements">Requirements</a></li>
<li class="toctree-l3"><a class="reference internal" href="#configuration">Configuration</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#python">Python</a></li>
<li class="toctree-l4"><a class="reference internal" href="#apache-httpd-configuration-windows">Apache HTTPD Configuration (Windows)</a></li>
<li class="toctree-l4"><a class="reference internal" href="#apache-httpd-configuration-linux-unix">Apache HTTPD Configuration (Linux/Unix)</a></li>
</ul>
</li>
</ul>
</li>
