...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>FTS Configuration dialog &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="FTS Dictionary Dialog" href="fts_dictionary_dialog.html" />
    <link rel="prev" title="Foreign Table Dialog" href="foreign_table_dialog.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="fts_dictionary_dialog.html" title="FTS Dictionary Dialog"
  ...
  <div class="section" id="fts-configuration-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>FTS Configuration dialog<a class="headerlink" href="#fts-configuration-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>FTS Configuration</em> dialog to configure a full text search. A text search configuration specifies a text search parser that can divide a string into tokens, along with dictionaries that can identify searchable tokens.</p>
<p>The <em>FTS Configuration</em> dialog organizes the development of a FTS configuration through the following dialog tabs: “<em>General</em>, <em>Definition</em>, and <em>Tokens</em>. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<p>Click the <em>General</em> tab to begin.</p>
<img alt="FTS configuration dialog general tab" src="_images/fts_configuration_general.png" />
<p>Use the fields in the <em>General</em> tab to identify a FTS configuration:</p>
<ul class="simple">
<li>Use the <em>Name</em> field to add a descriptive name for the FTS configuration. The name will be displayed in the <em>pgAdmin</em> tree control.</li>
<li>Use the drop-down listbox next to <em>Owner</em> to specify the role that will own the configuration.</li>
<li>Select the name of the schema in which the FTS configuration will reside from the drop-down listbox in the <em>Schema</em> field.</li>
<li>Store notes about the FTS configuration in the <em>Comment</em> field.</li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="FTS configuration dialog definition tab" src="_images/fts_configuration_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define parameters:</p>
<ul class="simple">
<li>Select the name of the text search parser from the drop-down listbox in the <em>Parser</em> field.</li>
<li>Select a language from the drop-down listbox in the <em>Copy Config</em> field.</li>
</ul>
<p>Click the <em>Tokens</em> tab to continue.</p>
<img alt="FTS configuration dialog tokens tab" src="_images/fts_configuration_tokens.png" />
<p>Use the fields in the <em>Tokens</em> tab to add a token:</p>
<ul class="simple">
<li>Use the <em>Tokens</em> field to specify the name of a token.</li>
<li>Click the <em>Add</em> icon (+) to create a token.</li>
<li>Use the <em>Dictionaries</em> field to specify a dictionary.</li>
</ul>
<p>Repeat these steps to add additional tokens; to discard a token, click the trash icon to the left of the row and confirm deletion in the <em>Delete Row</em> popup.</p>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>FTS Configuration</em> dialog generate a SQL command (see an example below). Use the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL command.</p>
<p><strong>Example</strong></p>
<p>The following is an example of the sql command generated by user selections in the <em>FTS Configuration</em> dialog:</p>
<img alt="FTS configuration dialog sql tab" src="_images/fts_configuration_sql.png" />
<p>The example shown demonstrates creating a FTS configuration named <em>meme_phrases</em>. It uses the <em>default</em> parser.</p>
<ul class="simple">
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">FTS Configuration dialog</a></li>
