...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Change Password Dialog &#8212; pgAdmin 4 3.1 documentation</title>
  ...
  <div class="section" id="change-password-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Change Password Dialog<a class="headerlink" href="#change-password-dialog" title="Permalink to this headline">¶</a></h1>
...
<img alt="Change database password dialog" src="_images/password.png" />
<p>Use the <em>Change Password</em> dialog to change your password:</p>
<ul class="simple">
<li>The name displayed in the <em>User</em> field is the role for which you are modifying the password; it is the role that is associated with the server connection that is highlighted in the tree control.</li>
<li>Enter the password associated with the role in the <em>Current Password</em> field.</li>
...
<p>Click the <em>OK</em> button to change your password; click <em>Cancel</em> to exit the dialog without changing your password.</p>
</div>
