...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Extension Dialog &#8212; pgAdmin 4 3.1 documentation</title>
  ...
  <div class="section" id="extension-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Extension Dialog<a class="headerlink" href="#extension-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Extension</em> dialog to install a new extension into the current database. An extension is a collection of SQL objects that add targeted functionality to your Postgres installation.  The <em>Extension</em> dialog adds the functionality of an extension to the current database only; you must register the extension in each database that use the extension.  Before you load an extension into a database, you should confirm that any pre-requisite files are installed.</p>
<p>The <em>Extension</em> dialog allows you to implement options of the CREATE EXTENSION command through the following dialog tabs: <em>General</em> and <em>Definition</em>. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="Extension dialog general tab" src="_images/extension_general.png" />
<p>Use the fields in the <em>General</em> tab to identify an extension:</p>
<ul class="simple">
<li>Use the drop-down listbox in the <em>Name</em> field to select the extension. Each extension must have a unique name.</li>
<li>Store notes about the extension in the <em>Comment</em> field.</li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Extension dialog definition tab" src="_images/extension_definition.png" />
<p>Use the <em>Definition</em> tab to select the <em>Schema</em> and <em>Version</em>:</p>
<ul class="simple">
<li>Use the drop-down listbox next to <em>Schema</em> to select the name of the schema in which to install the extension’s objects.</li>
<li>Use the drop-down listbox next to <em>Version</em> to select the version of the extension to install.</li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>Extension</em> dialog generate a SQL command (see an example below). Use the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL command.</p>
<p><strong>Example</strong></p>
<p>The following is an example of the sql command generated by user selections in the <em>Extension</em> dialog:</p>
<img alt="Extension dialog sql tab" src="_images/extension_sql.png" />
<p>The command creates the <em>chkpass</em> extension in the <em>public</em> schema.  It is version <em>1.0</em> of <em>chkpass</em>.</p>
<ul class="simple">
