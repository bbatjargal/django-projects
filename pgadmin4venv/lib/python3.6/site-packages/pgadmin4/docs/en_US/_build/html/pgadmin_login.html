...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>pgAdmin Login Dialog &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="User Management Dialog" href="pgadmin_user.html" />
  ...
  <div class="section" id="pgadmin-login-dialog">
<span id="pgadmin-login"></span><h1><span class="target" id="index-0"></span>pgAdmin Login Dialog<a class="headerlink" href="#pgadmin-login-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>pgAdmin Login</em> dialog to log in to pgAdmin:</p>
<img alt="pgAdmin login dialog" src="_images/pgadmin_login.png" />
<p>Use the fields in the <em>pgAdmin Login</em> dialog to authenticate your connection:</p>
<ol class="arabic simple">
<li>Provide the email address associated with your account in the <em>Email Address</em> field.</li>
<li>Provide your password in the <em>Password</em> field.</li>
<li>Click the <em>Login</em> button to securely log into pgAdmin.</li>
</ol>
<p><strong>Recovering a Lost Password</strong></p>
<p>If you cannot supply your password, click the <em>Forgotten your password?</em> button to launch a password recovery utility.</p>
<img alt="pgAdmin recover login password" src="_images/pgadmin_login_recover.png" />
<ol class="arabic simple">
<li>Provide the email address associated with your account in the <em>Email Address</em> field.</li>
<li>Click the <em>Recover Password</em> button to initiate recovery. An email, with directions on how to reset a password, will be sent to the address entered in the <em>Email Address</em> field.</li>
</ol>
<p>If you have forgotten the email associated with your account, please contact your administrator.</p>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">pgAdmin Login Dialog</a></li>
