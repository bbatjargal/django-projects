...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Management Basics &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="Add named restore point Dialog" href="add_restore_point_dialog.html" />
    <link rel="prev" title="Unique Constraint Dialog" href="unique_constraint_dialog.html" /> 
  </head><body>
  ...
  <div class="section" id="management-basics">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Management Basics<a class="headerlink" href="#management-basics" title="Permalink to this headline">¶</a></h1>
<p>pgAdmin provides point and click dialogs that help you perform server management functions.  Dialogs simplify tasks such as managing named restore points, granting user privileges, and performing VACUUM, ANALYZE and REINDEX functions.</p>
<p>Contents:</p>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="add_restore_point_dialog.html">Add named restore point Dialog</a></li>
<li class="toctree-l1"><a class="reference internal" href="change_password_dialog.html">Change Password Dialog</a></li>
<li class="toctree-l1"><a class="reference internal" href="grant_wizard.html">Grant Wizard</a></li>
<li class="toctree-l1"><a class="reference internal" href="import_export_data.html">Import/Export data Dialog</a></li>
<li class="toctree-l1"><a class="reference internal" href="maintenance_dialog.html">Maintenance Dialog</a></li>
</ul>
</div>
</div>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Management Basics</a><ul>
