...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Desktop Deployment &#8212; pgAdmin 4 3.1 documentation</title>
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>Desktop Deployment<a class="headerlink" href="#desktop-deployment" title="Permalink to this headline">¶</a></h1>
...
<p>The desktop runtime is a system-tray application that when launched, runs the
...
server log and shut down the server.</p>
...
are as follows:</p>
<ul class="simple">
<li><code class="docutils literal notranslate"><span class="pre">config.py</span></code>: This is the main configuration file, and should not be modified.
It can be used as a reference for configuration settings, that may be overridden
in one of the following files.</li>
<li><code class="docutils literal notranslate"><span class="pre">config_distro.py</span></code>: This file is read after <code class="docutils literal notranslate"><span class="pre">config.py</span></code> and is intended for
...
<li><code class="docutils literal notranslate"><span class="pre">config_local.py</span></code>: This file is read after <code class="docutils literal notranslate"><span class="pre">config_distro.py</span></code> and is intended
...
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">If the SERVER_MODE setting is changed in <code class="docutils literal notranslate"><span class="pre">config_distro.py</span></code> or <code class="docutils literal notranslate"><span class="pre">config_local.py</span></code>,
...
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>/Users/dpage/.virtualenvs/pgadmin4/lib/python2.7/site-packages/<span class="p">;</span>/Users/dpage/python-libs/
</pre></div>
</div>
...
and the registry on Windows (HKEY_CURRENT_USER\Software\pgadmin\pgadmin4).</p>
...
<tbody valign="top">
<tr class="row-even"><td>ApplicationPath</td>
<td>String</td>
<td>The directory containing pgAdmin4.py</td>
</tr>
<tr class="row-odd"><td>ConnectionTimeout</td>
<td>Integer</td>
<td>The number of seconds to wait for application server startup.</td>
</tr>
<tr class="row-even"><td>PythonPath</td>
<td>String</td>
<td>The Python module search path</td>
</tr>
<tr class="row-odd"><td>Browser/Geometry</td>
<td>Binary</td>
<td>The runtime window’s size/shape</td>
</tr>
<tr class="row-even"><td>Browser/WindowState</td>
<td>Binary</td>
<td>The runtime window’s state</td>
</tr>
<tr class="row-odd"><td>Browser/Zoom</td>
<td>String</td>
<td>The runtime window’s zoom level (zoom % / 100)</td>
</tr>
</tbody>
</table>
</div>
