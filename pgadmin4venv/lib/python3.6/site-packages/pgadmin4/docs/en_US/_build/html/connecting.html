...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Connecting to a Server &#8212; pgAdmin 4 3.1 documentation</title>
...
<span id="connecting"></span><h1><span class="target" id="index-0"></span>Connecting to a Server<a class="headerlink" href="#connecting-to-a-server" title="Permalink to this headline">¶</a></h1>
<p>Before you can use the pgAdmin client to manage the objects that reside on your Postgres server, you must define a connection to the server.  You can (optionally) use the <em>Server Group</em> dialog to create server groups to organize the server connections within the tree control for easier management. To open the <em>Server Group</em> dialog, right-click on the <em>Servers</em> node of the tree control, and select <em>Server Group</em> from the <em>Create</em> menu.</p>
<p>Contents:</p>
...
<p>Use the fields on the <em>Server</em> dialog to define the connection properties for each new server that you wish to manage with pgAdmin.  To open the <em>Server</em> dialog, right-click on the <em>Servers</em> node of the tree control, and select <em>Server</em> from the <em>Create</em> menu.</p>
<p>Contents:</p>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="server_dialog.html">Server Dialog</a></li>
</ul>
</div>
<p>After defining a server connection, right-click on the server name, and select <em>Connect to server</em> to authenticate with the server, and start using pgAdmin to manage objects that reside on the server.</p>
<p>Contents:</p>
<div class="toctree-wrapper compound">
<ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Connecting to a Server</a><ul>
