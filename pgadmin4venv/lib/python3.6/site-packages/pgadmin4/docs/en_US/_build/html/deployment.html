...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>pgAdmin Deployment &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="prev" title="Reviewing and Editing Data" href="editgrid.html" /> 
  </head><body>
  ...
  <div class="section" id="pgadmin-deployment">
<span id="deployment"></span><h1><span class="target" id="index-0"></span>pgAdmin Deployment<a class="headerlink" href="#pgadmin-deployment" title="Permalink to this headline">¶</a></h1>
<p>Pre-compiled and configured installation packages for pgAdmin 4 are available for a number of desktop environments; we recommend using an installer whenever possible.  If you are interested in learning more about the project, or if a pgAdmin installer is not available for your environment, the pages listed below will provide detailed information about creating a custom deployment.</p>
<p>Contents:</p>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">pgAdmin Deployment</a><ul>
