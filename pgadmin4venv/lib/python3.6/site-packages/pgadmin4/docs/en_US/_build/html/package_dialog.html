...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Package Dialog &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="Procedure Dialog" href="procedure_dialog.html" />
    <link rel="prev" title="Materialized View Dialog" href="materialized_view_dialog.html" /> 
  </head><body>
  ...
  <div class="section" id="package-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Package Dialog<a class="headerlink" href="#package-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Package</em> dialog to create a (user-defined) package specification.</p>
<p>The <em>Package</em> dialog organizes the management of a package through the following dialog tabs: <em>General</em>, <em>Code</em>, and <em>Security</em>. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="Package dialog general tab" src="_images/package_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the package:</p>
<ul class="simple">
<li>Use the <em>Name</em> field to add a descriptive name for the package. The name of a new package must not match any existing package in the same schema.</li>
<li>Select the schema in which the package will reside from the drop-down listbox in the <em>Schema</em> field.</li>
<li>Store notes about the package in the <em>Comment</em> field.</li>
</ul>
<p>Click the <em>Code</em> tab to continue.</p>
<img alt="Package dialog code tab" src="_images/package_code.png" />
<p>Use the fields in the <em>Code</em> tab to specify the package contents and to provide implementation details:</p>
<ul class="simple">
<li>Use the <em>Header</em> field to define the public interface for the package.</li>
<li>Use the <em>Body</em> field to provide the code that implements each package object.</li>
</ul>
<p>Click the <em>Security</em> tab to continue.</p>
<img alt="Package dialog security tab" src="_images/package_security.png" />
<p>Use the fields in the <em>Security</em> tab to to assign EXECUTE privileges for the package to a role. Click the <em>Add</em> icon (+) to set privileges for the package:</p>
<ul class="simple">
<li>Select the name of the role from the drop-down listbox in the <em>Grantee</em> field.</li>
<li>Click inside the <em>Privileges</em> field. Check the boxes to the left of a privilege to grant the selected privilege to the specified user.</li>
<li>Select the name of a role from the drop-down listbox in the <em>Grantor</em> field. The default grantor is the owner of the package.</li>
</ul>
<p>Click the <em>Add</em> icon (+) to assign additional privileges; to discard a privilege, click the trash icon to the left of the row, and confirm the deletion in the <em>Delete Row</em> popup.</p>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>Package</em> dialog generate a SQL command that creates or modifies a package definition:</p>
<img alt="Package dialog sql tab" src="_images/package_sql.png" />
<p>The example shown demonstrates creating a package named <em>empinfo</em> that includes one function and one procedure.</p>
<ul class="simple">
<li>Click the <em>Save</em> button to save work.</li>
<li>Click the <em>Cancel</em> button to exit without saving work.</li>
<li>Click the <em>Reset</em> button to delete any changes to the dialog.</li>
</ul>
</div>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Package Dialog</a></li>
