...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Backup and Restore &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="prev" title="Maintenance Dialog" href="maintenance_dialog.html" /> 
  </head><body>
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>Backup and Restore<a class="headerlink" href="#backup-and-restore" title="Permalink to this headline">¶</a></h1>
<p>A powerful, but user-friendly Backup and Restore tool provides an easy way to use pg_dump, pg_dumpall, and pg_restore to take backups and create copies of databases or database objects for use in a development environment.</p>
<p>Contents:</p>
