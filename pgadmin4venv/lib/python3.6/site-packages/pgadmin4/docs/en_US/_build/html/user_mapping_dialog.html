...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>User Mapping Dialog &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="View Dialog" href="view_dialog.html" />
    <link rel="prev" title="Type Dialog" href="type_dialog.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="view_dialog.html" title="View Dialog"
  ...
  <div class="section" id="user-mapping-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>User Mapping Dialog<a class="headerlink" href="#user-mapping-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>User Mapping</em> dialog to define a new mapping of a user to a foreign server.</p>
<p>The <em>User Mapping</em> dialog organizes the development of a user mapping through the following dialog tabs: <em>General</em> and <em>Options</em>. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="User Mapping dialog general tab" src="_images/user_mapping_general.png" />
<p>Use the drop-down listbox in the <em>User</em> field in the <em>General</em> tab to identify the connecting role:</p>
<ul class="simple">
<li>Select <em>CURRENT_USER</em> to use the name of the current role.</li>
<li>Select <em>PUBLIC</em> if no other user-specific mapping is applicable.</li>
<li>Select a pre-defined role name to specify the name of an existing user.</li>
</ul>
<p>Click the <em>Options</em> tab to continue.</p>
<img alt="User Mapping dialog options tab" src="_images/user_mapping_options.png" />
<p>Use the fields in the <em>Options</em> tab to specify connection options; the accepted option names and values are specific to the foreign data wrapper associated with the server specified in the user mapping. Click the <em>Add</em> button to add an option/value pair.</p>
<ul class="simple">
<li>Specify the option name in the <em>Option</em> field.</li>
<li>Provide a corresponding value in the <em>Value</em> field.</li>
</ul>
<p>Click <em>Add</em> to specify each additional option/value pair; to discard an option, click the trash icon to the left of the row and confirm deletion in the <em>Delete Row</em> popup.</p>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your entries in the <em>User Mapping</em> dialog generate a SQL command (see an example below). Use the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL command.</p>
<p><strong>Example</strong></p>
<p>The following is an example of the sql command generated by user selections in the <em>User Mapping</em> dialog:</p>
<img alt="User Mapping dialog sql tab" src="_images/user_mapping_sql.png" />
<p>The example shown demonstrates a user mapping for the <em>hdfs_server</em>. The user is <em>CURRENT_USER</em> with a password <em>secret</em>.</p>
<ul class="simple">
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">User Mapping Dialog</a></li>
