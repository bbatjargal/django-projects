...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synonym Dialog &#8212; pgAdmin 4 3.1 documentation</title>
    ...
    <link rel="next" title="Trigger function Dialog" href="trigger_function_dialog.html" />
    <link rel="prev" title="Sequence Dialog" href="sequence_dialog.html" /> 
  </head><body>
  ...
  <div class="section" id="synonym-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Synonym Dialog<a class="headerlink" href="#synonym-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Synonym</em> dialog to substitute the name of a target object with a user-defined synonym.</p>
<p>The <em>Synonym</em> dialog organizes the development of a synonym through the <em>General</em> tab. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="Synonym dialog general tab" src="_images/synonym_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the synonym:</p>
<ul class="simple">
<li>Use the <em>Name</em> field to specify the name of synonym. The name will be displayed in the <em>pgAdmin</em> tree control.</li>
<li>Select the name of the schema in which the synonym will reside from the drop-down listbox in the <em>Schema</em> field.</li>
</ul>
<p>In the definition panel, identify the target:</p>
<ul class="simple">
<li>Use the drop-down listbox next to <em>Target Type</em> to select the the type of object referenced by the synonym.</li>
<li>Use the drop-down listbox next to <em>Target Schema</em> to select the name of the schema in which the object resides.</li>
<li>Use the drop-down listbox next to <em>Target Object</em> to select the name of the object referenced by the synonym.</li>
</ul>
<p>Click the <em>SQL</em> tab to continue.</p>
<p>Your selections and entries in the <em>Synonym</em> dialog generate a SQL command.</p>
<img alt="Synonym dialog sql tab" src="_images/synonym_sql.png" />
<p>The example creates a synonym for the <em>emp</em> table named <em>emp_hist</em>.</p>
<ul class="simple">
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Synonym Dialog</a></li>
