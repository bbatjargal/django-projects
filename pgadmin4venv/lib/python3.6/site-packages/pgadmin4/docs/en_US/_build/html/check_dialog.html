...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Check Dialog &#8212; pgAdmin 4 3.1 documentation</title>
  ...
  <div class="section" id="check-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Check Dialog<a class="headerlink" href="#check-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Check</em> dialog to define or modify a check constraint. A check constraint specifies an expression that produces a Boolean result that new or updated rows must satisfy for an insert or update operation to succeed.</p>
<p>The <em>Check</em> dialog organizes the development of a check constraint through the <em>General</em> and <em>Definition</em> tabs. The <em>SQL</em> tab displays the SQL code generated by dialog selections.</p>
<img alt="Check dialog general tab" src="_images/check_general.png" />
<p>Use the fields in the <em>General</em> tab to identify the check constraint:</p>
<ul class="simple">
<li>Use the <em>Name</em> field to provide a descriptive name for the check constraint that will be displayed in the <em>pgAdmin</em> tree control. With PostgreSQL 9.5 forward, when a table has multiple check constraints, they will be tested for each row in alphabetical order by name and after NOT NULL constraints.</li>
<li>Store notes about the check constraint in the <em>Comment</em> field.</li>
</ul>
<p>Click the <em>Definition</em> tab to continue.</p>
<img alt="Check dialog definition tab" src="_images/check_definition.png" />
<p>Use the fields in the <em>Definition</em> tab to define the check constraint:</p>
<ul class="simple">
<li>Provide the expression that a row must satisfy in the <em>Check</em> field.</li>
...
<p>Your entries in the <em>Check</em> dialog generate a SQL command (see an example below). Use the <em>SQL</em> tab for review; revisit or switch tabs to make any changes to the SQL command.</p>
<p><strong>Example</strong></p>
<p>The following is an example of the sql command generated by user selections in the <em>Check</em> dialog:</p>
<img alt="Check dialog sql tab" src="_images/check_sql.png" />
<p>The example shown demonstrates creating a check constraint named <em>check_price</em> on the <em>price</em> column of the <em>products</em> table.  The constraint confirms that any values added to the column are greater than 0.</p>
<ul class="simple">
