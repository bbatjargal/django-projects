...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Add named restore point Dialog &#8212; pgAdmin 4 3.1 documentation</title>
  ...
  <div class="section" id="add-named-restore-point-dialog">
<span id="add-restore-point-dialog"></span><h1><span class="target" id="index-0"></span>Add named restore point Dialog<a class="headerlink" href="#add-named-restore-point-dialog" title="Permalink to this headline">¶</a></h1>
<p>Use the <em>Add named restore point</em> dialog to take a named snapshot of the state of the server for use in a recovery file. To create a named restore point, the server’s postgresql.conf file must specify a <em>wal_level</em> value of <em>archive</em>, <em>hot_standby</em>, or <em>logical</em>.  You must be a database superuser to create a restore point.</p>
<img alt="Restore point dialog" src="_images/add_restore_point.png" />
<p>When the <em>Restore point name</em> window launches, use the field <em>Enter the name of the restore point to add</em> to provide a descriptive name for the restore point.</p>
<p>For more information about using a restore point as a recovery target, please see the <a class="reference external" href="http://www.postgresql.org/docs/9.5/static/recovery-target-settings.html#RECOVERY-TARGET-NAME">PostgreSQL
documentation</a>.</p>
<ul class="simple">
<li>Click the <em>OK</em> button to save the restore point.</li>
